    ...
    try:
        if parsed_args.file:
            ...
            if not target_file.exists():
                ...
                doctify.main(filepath=target_file)
            ...
            if not target_path.exists():
                ...
                doctify.main(path=target_path.absolute())
